...
export const PERSONAS: AgentPersona[] = [
  ...
  },
  {
    ...
    movement: {
      wanderRadius: 100,
      idleChance: 0.55,
      zoneExploreChance: 0.04,
      zoneDwellMs: [15_000, 40_000],
      speedFactor: 0.75,
    },
    typoRate: 0.01,
    casualness: 'low',
  ...
  },
  {
    ...
    movement: {
      wanderRadius: 80,
      idleChance: 0.65,
      zoneExploreChance: 0.03,
      zoneDwellMs: [20_000, 50_000],
      speedFactor: 0.8,
    },
    typoRate: 0.02,
    casualness: 'medium',
  ...
  },
  {
    ...
    movement: {
      wanderRadius: 120,
      idleChance: 0.5,
      zoneExploreChance: 0.05,
      zoneDwellMs: [12_000, 35_000],
      speedFactor: 0.85,
    },
    typoRate: 0.02,
    casualness: 'low',
